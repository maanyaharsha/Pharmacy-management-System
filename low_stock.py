...
root.title("Low Stock Alert")

root.geometry("900x550+180+70")
...
medicine_table.column("name", width=180)
medicine_table.column("company", width=180)
...
Label(
    root,
    text="Medicines with stock less than 10 are shown above",
    bg="#f0f2f5",
    fg="red",
